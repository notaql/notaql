 ...
 */
public class MongoDBOutputPathStepVisitor extends NotaQL2DocumentOutBaseVisitor<OutputPathStep> {
    private final TransformationParser parser;

    public MongoDBOutputPathStepVisitor(TransformationParser parser) {
        this.parser = parser;
    }
